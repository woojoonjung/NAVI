...
def load_training_variant_model(domain, epoch=None, header_encoder_mode='full', seed=None):
    ...
    if seed is not None:
        ...
        if epoch is not None and epoch in [1, 2, 3]:
    ...
    elif epoch is not None and epoch in [1, 2, 3]:
        # E1, E2, or E3 from default_3epoch
...
def calculate_validation_loss(model, validation_data, device, loss_fns, collator, ablation_type="full", 
    ...
    Args:
        ...
        ablation_type: Ablation type ('full', 'woSSI', 'woMSM', 'woESA')
...
def main():
    ...
    validation_dir = f"./data/cleaned/{args.domain}/validation"
