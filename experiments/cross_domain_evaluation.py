...
def load_cross_domain_models():
    """
    Load epoch2 checkpoints from navi_product_default_3epoch and navi_movie_default_3epoch.
    ...
    # Product model - epoch 2
    product_model_path = "./models/navi_product_default_3epoch/full_HVB_seed42_cleaned_tau0.07_0.13_quartile_epoch_2"
    ...
    # Movie model - epoch 2
    movie_model_path = "./models/navi_movie/full_HVB_seed42_cleaned_tau0.07_0.13_quartile_epoch_2"
...
def load_classification_data(domain):
    ...
    """
    if domain == 'Product':
        data_path = "data/cleaned/Product/test/WDC_product_for_cls.jsonl"
        target_col = 'category'
        ...
        data_path = "data/cleaned/Movie/test/WDC_movie_for_cls.jsonl"
        target_col = 'genres'
