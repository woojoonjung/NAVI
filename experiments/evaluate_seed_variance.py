#!/usr/bin/env python3
"""
Evaluate seed variance across multiple training runs.

This script aggregates metrics from multiple training runs with different seeds
and generates variance statistics and plots.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate seed variance across training runs")
