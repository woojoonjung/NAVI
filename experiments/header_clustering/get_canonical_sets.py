...
_bert_name = app_config.get_bert_name() if app_config else "bert-base-uncased"
_bert_kw = {"local_files_only": app_config.use_local_files_only()} if app_config else {}
...
def main():
    ...
    for domain in args.domains:
        ...
        if args.cluster_method == 'semantic':
            ...
            bert_for_clustering_mlm = BertForMaskedLM.from_pretrained(_bert_name, **_bert_kw).to(device)
            tokenizer_for_clustering = BertTokenizer.from_pretrained(_bert_name, **_bert_kw)
