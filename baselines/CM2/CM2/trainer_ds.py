...
class Trainer_ds:
    def __init__(self,
        ...
        **kwargs,
        ...
        # region agent log
        _agent_dbg("H2", "trainer_ds.py:__init__:entry", "Trainer_ds init", {"n_train": len(train_set_list) if train_set_list else 0})
        # endregion
        self.flag = flag
        self.model = model
        ...
        # region agent log
        _agent_dbg("H4", "trainer_ds.py:before_deepspeed_cfg", "create_optimizer done", {"n_params_groups": len(parameters) if hasattr(parameters, "__len__") else "na"})
        # endregion
        ...
        # region agent log
        _agent_dbg("H1", "trainer_ds.py:before_deepspeed_initialize", "about to call deepspeed.initialize", {"warmup_num_steps": ds_config['scheduler']['params']['warmup_num_steps'], "num_training_steps": self.args['num_training_steps'], "warmup_steps": warmup_steps})
        # endregion
        ...
        # region agent log
        _agent_dbg("H1", "trainer_ds.py:deepspeed_initialize:return", "deepspeed.initialize returned", {})
        # endregion
        logger.info(f'deepspeed init finish')
        # region agent log
        _agent_dbg("H2", "trainer_ds.py:before_CM2FeatureExtractor", "constructing CM2FeatureExtractor", {})
        # endregion
        ...
        new_test_list = []
        # region agent log
        _agent_dbg("H2", "trainer_ds.py:feature_extract:start", "starting train feature extraction", {"n_tables": len(train_set_list)})
        # endregion
        ...
        # region agent log
        _agent_dbg("H2", "trainer_ds.py:after_all_feature_extract", "all train feature extracts done", {"n": len(new_train_list)})
        # endregion
        ...
        # region agent log
        _agent_dbg("H5", "trainer_ds.py:after_train_dataloaders", "train DataLoaders built", {"n_loaders": len(self.trainloader_list)})
        # endregion
        ...
        # region agent log
        _agent_dbg("H2", "trainer_ds.py:__init__:complete", "Trainer_ds __init__ finished", {})
        # endregion
