...
# Usage Example:
# bash train_1128_product.sh

# NAVI Model Training Script (Tau Parameter Search)
# Fixed alignment_weight to 0.05
# Explores high_entropy_tau and low_entropy_tau parameter space
...
# ===============================
echo "=========================================="
echo "Starting NAVI Model Training (Tau Parameter Search)"
echo "Date: $(date)"
echo "GPU: ${GPU_IDX}"
...
# ===============================
# Tau Parameter Configurations
# ===============================
# Format: high_entropy_tau low_entropy_tau
# Fixed alignment_weight = 0.05
CUSTOM_CONFIGS=(
    "0.015 0.12"
    "0.015 0.14"
    "0.015 0.16"
...
echo "Collecting Tau Parameter Configurations..."
echo "Fixed Alignment Weight: ${ALIGNMENT_WEIGHT}"
for dataset in "${DATASET_LIST[@]}"; do
    for config in "${CUSTOM_CONFIGS[@]}"; do
        ...
        align_safe=$(convert_to_safe_name "$ALIGNMENT_WEIGHT")
