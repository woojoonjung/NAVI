...
for dataset in "${DATASET_LIST[@]}"; do
    for config in "${CUSTOM_CONFIGS[@]}"; do
        ...
        # Create model name: navi_<dataset>_tau<high>_<low>_align<align>_ethresh10_90_ga1
        model_name="navi_${dataset,,}_tau${high_tau_safe}_${low_tau_safe}_align${align_safe}_ethresh10_90_ga1"
        log_suffix="tau${high_tau_safe}_${low_tau_safe}_align${align_safe}_ethresh10_90_ga1"
